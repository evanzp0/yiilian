...
```
| <len = 1 + X> : int(4) | 5 : int(1) | <bitfield> : byte(X) |
```
...
```
| <len = 8> : int(4) | 4 : int(1) | <index> : int(4) |
```
...
```
| <len = 13> : int(4) | 6 : int(1) | <index> : int(4) | <begin> : int(4) | <length> : int(4) |
```
...
```
| <len = 13> : int(4) | 8 : int(1) | <index> : int(4) | <begin> : int(4) | <length> : int(4) |
```
...
```
| <len = 9 + X> : int(4) | 7 : int(1) | <index> : int(4) | <begin> : int(4) | <piece> : byte(X) |
```
