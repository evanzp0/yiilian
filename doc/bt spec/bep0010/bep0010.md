...
> *译注：extended message ID = 0 表示是 handshake，它的 extension_header 含有该 peer 所支持的所有扩展消息 ID；当 extended message ID > 0 时，它的值需要和本地发送的 handshake payload 中声明的 extended message ID 一致*
>
